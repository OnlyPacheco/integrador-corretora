...
module.exports = async function handler(req, res) {
    ...
    for (const row of imoveis) {
        ...
        let trans1 = '', trans2 = '';
        if (precoVenda > 0 && precoAluguel > 0) {
            trans1 = 'V';
            trans2 = 'L';
        } else if (precoAluguel > 0) {
            trans1 = '';
            trans2 = 'L';
        ...
        xml += tag('valor_locacao', precoAluguel > 0 ? soNumeros(String(precoAluguel)) : '');
